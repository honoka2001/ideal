    ...
    <div class="inner">
      ...
      <div class="boad detail">
        ...
        <div class="cards">
          ...
          <div class="form">
            <form action='blog_update_form.php'>
              <i class="far fa-edit"></i>
              <input type='submit' class='update' value='編集'>
         </form>

            <form action='blog_delete.php'>
              <i class="fas fa-trash-alt"></i>
              <input type='submit' class='deleat' value='削除' onclick="return confirm('投稿を本当に削除しますか？')">
            </form>
          </div>
            ...
            <p class="detail_content"><?php echo str_replace("&amp;#13;&amp;#10;","<br>",nl2br(h($result['content']))); ?></p>
            <p class="btn"><a href="mypage.php">戻る</a></p>
